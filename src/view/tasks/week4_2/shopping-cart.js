...
import url from './books.xml';
import imageUrl from './book-icon.jpg';

global.nextItem = 0; //The index of next ietm to be added
global.currentCart = new Array(); //This array contains the current items in the cart
...
function displayBooks()
{
	...
	let txt="<table border='0px' id='tblBook' cellpadding='3px' cellspace='0px'>";
	...
	for (let i=0;i<books.length;i++)
	{
		...
		let bookChildren=books[i].getElementsByTagName("TITLE");
		...
		txt+=`<td align='right'><img src=${imageUrl} /></td>`;
